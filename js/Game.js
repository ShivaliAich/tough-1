class Game{
    ...
    if (keyIsDown(LEFT_ARROW) && player.index !== null) {
     ...
     if (frameCount % 80 === 0) {
      ...
      if(player.lives===0){
        ...
        fill("blue");
        text(allPlayers.player1.name +" is still playing with lives "+allPlayers.player1.lives,150,150);
        fill("yellow");
        text(allPlayers.player2.name +" is still playing with lives "+allPlayers.player2.lives,150,200);
        fill("green");
        text(allPlayers.player3.name +" is still playing with lives "+allPlayers.player3.lives,150,250);
        fill("red");
        text(allPlayers.player4.name +" is still playing with lives "+allPlayers.player4.lives,150,300);
    }
    if(allPlayers.player1.lives === 0 && allPlayers.player2.lives ===0 && allPlayers.player3.lives==0 && allPlayers.player4.lives==0){
      ...
      textSize(25);
      fill("white");
      text("Press the restart button to play again",500,100);
    ...
    this.restart.mousePressed(()=>{
      ...
      fill("black");
      textSize(25);
      text("Reload the page to play again",300,700);
      this.play();
    })
  }
